...
$THEME->name = 'essentialsummer';

// The only thing you need to change in this file when copying it to
// create a new theme is the name above. You also need to change the name
// in version.php and lang/en/theme_essentialsummer.php as well.

$THEME->doctype = 'html5';
$THEME->yuicssmodules = array();
$THEME->parents = array('bootstrapbase');
$THEME->sheets = array('slides', 'categories', 'font-awesome.min', 'essentialsummer', 'alternative1', 'alternative2', 'alternative3', 'settings');
...
$THEME->csspostprocess = 'theme_essentialsummer_process_css';
