...
/**
 * Strings for component 'theme_essentialsummer', language 'fr', branch 'MOODLE_26_STABLE'
 *
...
$string['alternativecolors'] = 'Couleurs de remplacement {$a}';
$string['alternativethemecolor'] = 'Couleur de remplacement du thème {$a}';
$string['alternativethemecolordesc'] = 'Quelle devrait être la couleur de votre thème pour les couleurs de remplacement {$a}. Si elle est activée et que l\'utilisateur la sélectionne, elle remplacera la couleur par défaut du thème.';
$string['alternativethemecolors'] = 'Couleurs de remplacement du thème';
$string['alternativethemecolorsdesc'] = 'Définit les couleurs de remplacement du thème que l\'utilisateur pourrait sélectionner.';
$string['alternativethemehovercolor'] = 'Couleur de survol de remplacement du thème {$a}';
$string['alternativethemehovercolordesc'] = 'Quelle devrait être la couleur de survol de votre thème pour les couleurs de remplacement {$a}. Si elle est activée et que l\'utilisateur la sélectionne, elle remplacera la couleur de survol par défaut du thème.';
...
$string['categoryicon'] = 'Catégorie';
$string['categoryicondesc'] = 'Si elle est activée, cela vous permettra de définir des icônes pour chaque catégorie de cours.';
$string['categoryiconheading'] = 'Affichage des catégories basé sur des icônes';
$string['categoryiconheadingsub'] = 'Utilise des icônes pour représenter vos catégories';
$string['categoryiconinfo'] = 'Définit des icônes de catégories personnalisées';
$string['categoryiconinfodesc'] = 'Chaque icône est réglé par «ID de catégorie». Vous obtenez ces Identifiants en consultant l\'URL ou chaque catégorie.';
$string['choosereadme'] = '<div class="clearfix"><div class="well"><h2> Clean </h2><p><img class=img-polaroid src="clean/pix/screenshot.jpg" /></p></div><div class="well"><h3> À propos de Essential pour l\'été </h3><p> Essential pour l\'été est un thème modifié Bootstrap de Moodle  qui hérite des styles et des moteurs de rendus de son thème parent. </p><h3> Parents </h3><p> Ce thème est basé sur le thème  Bootstrap, qui a été créé pour Moodle 2.5, avec l\'aide de: <br> Stuart Lamour, Mark Aberdour, Paul Hibbitts, Mary Evans. </p><h3> Crédits du thème </h3><p> Auteurs: Julian Ridden <br> Contact: julian@moodleman.net <br> Site Web: <a href="http://www.moodleman.net">www.moodleman.net</a> </p></div></div>';
...
$string['configtitle'] = 'Essential pour l\'été';
...
$string['defaultcategoryicon'] = 'Icône par défaut des catégories';
$string['defaultcategoryicondesc'] = 'Définit une icône par défaut des catégories';
...
$string['editiconsdesc'] = 'Ceci utilise la police Awesome pour afficher des icônes d\'édition colorées et plus fines dans les pages de cours et les blocs. Veuillez noter que ceci n\'est actuellement pas compatible avec la fonctionnalité de masquage automatique.';
$string['enablealert'] = 'Activer l\'alerte';
$string['enablealertdesc'] = 'Active ou désactive les alertes';
$string['enablealternativethemecolors'] = 'Active les couleurs de remplacement {$a} du thème';
$string['enablealternativethemecolorsdesc'] = 'Si activé, l\'utilisateur sera en mesure de sélectionner les couleurs de remplacement {$a} du thème.';
...
$string['footercolorsdesc'] = 'Change les couleurs des pieds-de-page';
...
$string['frontcontentheadingsub'] = 'Choisissez quelles fonctionnalités vous souhaiter activer sur la page d\'accueil de votre moodle';
$string['frontpageblocks'] = 'Alignement des blocs de la page d\'accueil';
$string['frontpageblocksdesc'] = 'Ici vous pouvez déterminer si vos blocs de la page d\'accueil doivent s\'aligner sur la gauche ou sur la droite.';
$string['frontpagemiddleblocks'] = 'Activer les blocs centraux sur la page d\'accueil';
$string['frontpagemiddleblocksdesc'] = 'Si activé, ceci affichera 3 nouveaux emplacements pour les blocs juste sous les annonces marketing';
...
$string['pagewidth'] = 'Définir la largeur de la page';
...
$string['pluginname'] = 'Essential pour l\'été';
...
$string['region-home-middle'] = 'Accueil (Centrale)';
$string['region-home-right'] = 'Accueil (Droite)';
$string['region-side-post'] = 'Droite';
$string['region-side-pre'] = 'Gauche';
$string['right'] = 'Droite';
$string['sideregionsmaxwidth'] = 'Utiliser une largeur maximum pour les régions latérales';
$string['sideregionsmaxwidthdesc'] = 'Ce thème utilise la mise en page fluide. Dans les écrans larges, les régions latérales contenant des blocs peuvent devenir inutilement grande. Cocher cet option afin de limiter la largeur de ces régions.';
...
$string['slidebuttoncolordesc'] = 'De quelle couleur devrait être le bouton « Lire la suite »';
...
$string['slidecolors'] = 'Couleurs du diaporama';
$string['slidecolorsdesc'] = 'Change les couleurs du diaporama';
$string['slideheadercolor'] = 'Couleur du titre du diaporama';
$string['slideheadercolordesc'] = 'Quelle couleur devrait avoir le titre de la diapositive';
...
$string['slideshow1'] = 'Petite image sur la droite';
$string['slideshow2'] = 'Grande image de fond';
$string['slideshow3'] = 'Design trois';
...
$string['slideshowvariant'] = 'Design du diaporama';
$string['slideshowvariantdesc'] = 'Choisissez le style du diaporama';
...
$string['usecategoryicon'] = 'Activer les icônes des catégories';
